...
总结 :    
#绿色错误解决办法
1. 设计 - 工具规则检查 - 关闭所有除了Electronic error的错误
2. 使用T - M 快捷键复位错误
3. 开始布线
你可以自己分析绿色错误的原因,有些错误并不影响线路板的布线.
![](assets/截图_20231215142617.png)
有时候因为这种间距过小导致的绿色错误其实是没有关系的,我们可以直接复位不去管他.当然在这张图中并没有出现绿色错误.
____   
